...
public class LerTeclado {
	public static void main(String[] args) {
		Scanner scan = new Scanner(System.in); // instancía
		...
		System.out.println("Seu nome completo é : " + nomeCompleto); // printa output da variavel
		...
		System.out.println("Sua idade é: " + suaIdade + " anos"); */
		
		System.out.println("Digite o seu primero nome, idade, quantidade de filhos, altura e se tem algum animale de estimação");
		String primeiroNome = scan.next();
		int suaIdade = scan.nextInt();
		byte qtdFilhos = scan.nextByte();
		float altura = scan.nextFloat();
		boolean animalEstimacao = scan.nextBoolean();
		System.out.println("Seu nome: " + primeiroNome + ", Idade: " + suaIdade + ", filhos: " + qtdFilhos + ", altura: " + altura + " Animais de estimação: " + animalEstimacao);
	}
}